...
python train.py --experiment_name abcdASTWPActionAll \
 --model_name_or_path results/abcdASTWPActionAll_input_target_t5-small \
  --do_predict \
...
#  --model_name_or_path results/abcdASTWPActionHalf_input_target_t5-small \
#   --do_predict \
...
#  --model_name_or_path results/abcdASTWPAction1P_input_target_t5-small \
#   --do_predict \
...
# export CUDA_VISIBLE_DEVICES=6,7
# echo "abcdASTWPAction10P"
# python train.py --experiment_name abcdASTWPAction10P \
#  --model_name_or_path results/abcdASTWPAction10P_input_target_t5-small \
#   --do_predict \
#   --train_file ./data/processed/train_AST_abcd_wpaction_10p.json \
#   --validation_file ./data/processed/dev_AST_abcd_wpaction_10p.json \
#   --test_file ./data/processed/test_AST_abcd_wpaction_10p.json \
#   --text_column input \
#   --summary_column target \
#   --per_device_train_batch_size 32 \
#   --per_device_eval_batch_size 32 \
...
#  --model_name_or_path results/abcdASTWPAction20P_input_target_t5-small \
#   --do_predict \
...
# python train.py --experiment_name abcdASTWPAction30P \
#  --model_name_or_path results/abcdASTWPAction30P_input_target_t5-small \
#   --do_predict \
#   --train_file ./data/processed/train_AST_abcd_wpaction_30p.json \
#   --validation_file ./data/processed/dev_AST_abcd_wpaction_30p.json \
