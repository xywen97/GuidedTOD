...
#  --model_name_or_path results/abcdASTWMostPActionNoinitChainHalf_input_target_t5-small \
#   --do_predict \
...
python train.py --experiment_name abcdASTWMostPActionNoinitChain10P \
 --model_name_or_path results/abcdASTWMostPActionNoinitChain10P_input_target_t5-small \
  --do_predict \
...
#  --model_name_or_path results/abcdASTWMostPActionNoinitChain30P_input_target_t5-small \
#   --do_predict \
