...
# # 10p
export CUDA_VISIBLE_DEVICES=6,7
echo "abcdASTWPAction10PUpper"
python train.py --experiment_name abcdASTWPAction10PUpper \
 --model_name_or_path t5-small \
  --do_train \
  --do_eval \
  --do_predict \
  --num_train_epochs 100 \
  --train_file ./data/processed/train_AST_abcd_wpaction_upper_10p.json \
  --validation_file ./data/processed/dev_AST_abcd_wpaction_upper_10p.json \
  --test_file ./data/processed/test_AST_abcd_wpaction_upper_10p.json \
  --text_column input \
  --summary_column target \
  --per_device_train_batch_size 32 \
  --per_device_eval_batch_size 32 \
...
# delete the saved model
rm -rf results/abcdASTWPAction10PUpper_input_target_t5-small/checkpoint-*
...
export CUDA_VISIBLE_DEVICES=6,7
echo "abcdASTWPAction30PUpper"
python train.py --experiment_name abcdASTWPAction30PUpper \
 --model_name_or_path t5-small \
  --do_train \
  --do_eval \
  --do_predict \
  --num_train_epochs 100 \
  --train_file ./data/processed/train_AST_abcd_wpaction_upper_30p.json \
  --validation_file ./data/processed/dev_AST_abcd_wpaction_upper_30p.json \
  --test_file ./data/processed/test_AST_abcd_wpaction_upper_30p.json \
  --text_column input \
  --summary_column target \
  --per_device_train_batch_size 32 \
  --per_device_eval_batch_size 32 \
...
# delete the saved model
rm -rf results/abcdASTWPAction30PUpper_input_target_t5-small/checkpoint-*
